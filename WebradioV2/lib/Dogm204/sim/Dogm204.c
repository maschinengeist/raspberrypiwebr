...
static INT_U8 Terminal[4][20], u08PosX = 0, u08PosY = 0;



void Dogm204_Print(void)
{
	INT_U8 u08Loop;
...
/***********************************************************************
*/
/*! \fn RESULT Dogm204_Init(INT_U8 u08Mode)
*
...
/***********************************************************************
*/
/*! \fn void Dogm204_WriteString(CHAR* cText)
*
...
/***********************************************************************
*/
/*! \fn void Dogm204_PrintChar(CHAR cChar, INT_U8 u08X, INT_U8 u08Y)
*
*   \brief write a string to the display
*
*   \param cText --> Nullterminated string to send
...
*
*   \param u08On --> BACKLIGHT_ON or BACKLIGHT_OFF
*
*************************************************************************/
void Dogm204_Backlight(INT_U8 u08On)
{
	/* check mode */
	if(u08On == BACKLIGHT_ON)
	{
		//printf(BC_BLACK);
		//printf(CL_WHITE);
	}
